...
# Author: nivkarasenty and rephaelriahi
# Description: Trying to use fm modulation on our modulation to move it through sound
...
class fm_modulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FM modulated signal", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM modulated signal")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fm_modulation")
        ...
        self.qtgui_time_sink_x_2 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "time domain after demodulating fm", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_1 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "time sink before fm modulation", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "time sink with all modulation", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.modulator_modulator_0 = modulator.modulator(t, samp_rate, input_str)
